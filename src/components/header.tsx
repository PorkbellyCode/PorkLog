  ...
  return (
    <header className="sticky top-0 z-40 h-14 bg-[#1f2328] text-white print:hidden">
      <div className="flex h-full items-center justify-between gap-4 px-6">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-base font-semibold tracking-tight hover:opacity-80 transition-opacity"
        >
          {/* Twemoji 🥓 (CC-BY 4.0) */}
          <svg viewBox="0 0 36 36" width={18} height={18} aria-hidden="true" className="shrink-0">
