...
export const skillCategories: { category: string; items: Skill[] }[] = [
  ...
  },
  {
    category: "Backend",
    items: [
      { name: "Java", icon: "java", level: 2 },
      { name: "Spring Boot", icon: "springboot", level: 2 },
    ],
  },
  {
    category: "Database",
    items: [
      { name: "Oracle", icon: "oracle", level: 2 },
      { name: "MariaDB", icon: "mariadb", level: 2 },
      { name: "MSSQL", icon: "mssql", level: 2 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Vercel", icon: "vercel", level: 1 },
    ],
  },
  {
    category: "DevOps",
    items: [
      ...
      { name: "GitHub Actions", icon: "githubactions", level: 1 },
